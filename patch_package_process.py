...
from patch_package_chunk import patch_package_chunk
...
class PatchProcess:
    def __init__(self, partition, tgt_image, src_image,
        ...
        # ab copy param
        # self.all_blocks_list_obj = all_blocks_list
        # self.no_copy_list_obj = no_copy_list
        # self.no_cop_list_size = len(no_copy_list)
    ...
    def after_for_process(self, max_stashed_blocks, total_blocks_count,
        ...
        # print(" All Transfer Content:", transfer_content)
    ...
    def compute_diff_patch(self, each_action, patch_dat_file_obj, diff_offset,
        ...
        try:
            ...
            print(f'old patch len:{len(patch_value)}')
            ...
            if OPTIONS_MANAGER.stream_update and len(patch_value) > OPTIONS_MANAGER.chunk_limit * 4096:
                ...
                # Do the slicing here
                    ...
                    old_patch_value_len = len(patch_value)
                    patch_package_chunk_obj = patch_package_chunk(src_file_obj.name, tgt_file_obj.name, do_pkg_diff, transfer_content,
                    ...
                    print(f'transfer_content len:{len(transfer_content)}')
                patch_value = ''                                         
            src_file_obj.close()
            tgt_file_obj.close()
        except ValueError:
    ...
    def add_ab_copy_content(self, blocks_length, need_copy_blocks_list, transfer_content):
        ...
        if len(need_copy_blocks_list):
            ...
            new_line = "{type_str} {tgt_string_len},{tgt_string} {length} {src_str_len},{src_str}".format(type_str = 'copy',
    ...
    def write_split_transfers(self, transfer_content, type_str, target_blocks, each_img_file):
        ...
        while target_blocks.size() != 0:
            ...
            if type_str == ActionType.NEW:
                # 解析写入的块
                range = self.parse_ranges(blocks_to_write.to_string_raw())
